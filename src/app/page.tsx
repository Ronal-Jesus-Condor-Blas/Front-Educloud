          ...
          <div className="max-w-2xl mx-auto text-center">
            ...
            <div className="relative">
              <input
                ...
                className="w-full px-4 sm:px-6 py-3 sm:py-4 text-base sm:text-lg bg-white text-black border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-400 focus:border-transparent pr-20 sm:pr-24"
              />
              <button className="absolute right-2 top-1/2 transform -translate-y-1/2 bg-green-400 text-black px-3 sm:px-6 py-2 rounded-lg font-semibold hover:bg-green-300 transition-colors text-sm sm:text-base">
                Buscar
              </button>
            </div>
          </div>
